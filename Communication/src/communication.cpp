...
int leia()
{
	...
	//arqIP = "127.0.0.1";
	if((arqIP=ini->getChar("Communication","server","-1024"))=="-1024"){
		cout<<"Erro na leitura do conf.ini";
		return(0);
	}
	if((arqPORT=ini->getd("Communication","port",-1024))==-1024){
		cout<<"Erro na leitura do conf.ini";
		return(0);
	}
	if((arqTEAMColor=ini->getd("Communication","team_robofei",-1024))==-1024){
		cout<<"Erro na leitura do conf.ini";
		return(0);
	}
	if((arqOPPColor=ini->getd("Communication","team_opponent",-1024))==-1024){
		cout<<"Erro na leitura do conf.ini";
		return(0);
	}
	if((arqROBOFEINo=ini->getd("Communication","no_team_robofei",-1024))==-1024){
		cout<<"Erro na leitura do conf.ini";
		return(0);
	}
	if((arqROBOFEIPlayerNo=ini->getd("Communication","no_player_robofei",-1024))==-1024){
		cout<<"Erro na leitura do conf.ini";
		return(0);
	}
