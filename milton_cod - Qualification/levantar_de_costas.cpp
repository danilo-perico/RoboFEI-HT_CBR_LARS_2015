...
printf("Levantando\n");
	...
	dxl_write_word(16, P_GOAL_POSITION_L, 722+20);
...
//dxl_write_word(18, P_GOAL_POSITION_L, 929);
	...
	dxl_write_word(16, P_GOAL_POSITION_L, 559+20);
	...
	espera_mov();
	dxl_write_word(18, MOVING_SPEED, 200);//50
	dxl_write_word(12, MOVING_SPEED, 200);//50
	dxl_write_word(16, MOVING_SPEED, 80);//20
	dxl_write_word(22, MOVING_SPEED, 80);//20
	...
	dxl_write_word(16, P_GOAL_POSITION_L, 740-15);
	dxl_write_word(22, P_GOAL_POSITION_L, 295+15);
