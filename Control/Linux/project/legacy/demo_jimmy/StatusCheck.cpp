...
//			mPlay(17,SOCCER,DONT_WAIT);
		...
		if(LinuxActionScript::m_is_running == 0)
			...
			m_cur_mode = SOCCER;
		      ...
		      Walking::GetInstance()->m_Joint.SetEnableBody(false);
		      Action::GetInstance()->m_Joint.SetEnableBody(true);		
                	LinuxActionScript::ScriptStart(SCRIPT8_FILE_PATH);
		      while(Action::GetInstance()->IsRunning() == true) usleep(8000);		
			}
		...
		if(LinuxActionScript::m_is_running == 0)
			...
			m_cur_mode = SOCCER;
		      ...
		      Walking::GetInstance()->m_Joint.SetEnableBody(false);
		      Action::GetInstance()->m_Joint.SetEnableBody(true);		
                	LinuxActionScript::ScriptStart(SCRIPT6_FILE_PATH);
		      while(Action::GetInstance()->IsRunning() == true) usleep(8000);		
			}
		while(PS3.key.Circle != 0) usleep(8000);
		}
		...
		if(LinuxActionScript::m_is_running == 0)
			...
			m_cur_mode = SOCCER;
		      ...
		      Walking::GetInstance()->m_Joint.SetEnableBody(false);
		      Action::GetInstance()->m_Joint.SetEnableBody(true);		
                	LinuxActionScript::ScriptStart(SCRIPT7_FILE_PATH);
		      while(Action::GetInstance()->IsRunning() == true) usleep(8000);		
			}
		while(PS3.key.Triangle != 0) usleep(8000);
		}
		...
		if(LinuxActionScript::m_is_running == 0)
			...
			m_cur_mode = SOCCER;
		      ...
		      Walking::GetInstance()->m_Joint.SetEnableBody(false);
		      Action::GetInstance()->m_Joint.SetEnableBody(true);		
                	LinuxActionScript::ScriptStart(SCRIPT1_FILE_PATH);
		      while(Action::GetInstance()->IsRunning() == true) usleep(8000);		
			}
		while(PS3.key.Square != 0) usleep(8000);
		}
		...
		if(LinuxActionScript::m_is_running == 0)
			...
			m_cur_mode = SOCCER;
		      ...
		      Walking::GetInstance()->m_Joint.SetEnableBody(false);
		      Action::GetInstance()->m_Joint.SetEnableBody(true);
                	LinuxActionScript::ScriptStart(SCRIPT2_FILE_PATH);
		      while(Action::GetInstance()->IsRunning() == true) usleep(8000);
			}
		...
		if(LinuxActionScript::m_is_running == 0)
			...
			m_cur_mode = SOCCER;
		      ...
		      Walking::GetInstance()->m_Joint.SetEnableBody(false);
		      Action::GetInstance()->m_Joint.SetEnableBody(true);
                	LinuxActionScript::ScriptStart(SCRIPT3_FILE_PATH);
			}
		...
		if(LinuxActionScript::m_is_running == 0)
			...
			m_cur_mode = SOCCER;
		      ...
		      Walking::GetInstance()->m_Joint.SetEnableBody(false);
		      Action::GetInstance()->m_Joint.SetEnableBody(true);
                	LinuxActionScript::ScriptStart(SCRIPT4_FILE_PATH);
			}
		...
		if(LinuxActionScript::m_is_running == 0)
			...
			m_cur_mode = SOCCER;
		      ...
		      Walking::GetInstance()->m_Joint.SetEnableBody(false);
		      Action::GetInstance()->m_Joint.SetEnableBody(true);
                	LinuxActionScript::ScriptStart(SCRIPT5_FILE_PATH);
			}
