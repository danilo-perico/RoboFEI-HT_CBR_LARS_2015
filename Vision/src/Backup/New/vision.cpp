...
//-------------para entrada de argumentos-----------------------------------
 namespace po=boost::program_options;
  ...
  desc.add_options()
    ...
    ("Nea", "Capture open for histogram save from Near (Use together with F1...F4 Argments)")
...
//******************************************************************************************************
	...
	/// Computation of distances from Color Histogram vectors and Gradient Histogram vectors
		...
		vector<float> HOGFieldFar, HOGFieldMed, HOGFieldNear, ColorFieldFar, ColorFieldMed, ColorFieldNear;
		...
		{
		HOGFieldFar    = openFiletoGetHistogramVector("genfiles/Fields/HOGFieldOneFar.dat");
		HOGFieldMed    = openFiletoGetHistogramVector("genfiles/Fields/HOGFieldOneMed.dat");
		HOGFieldNear   = openFiletoGetHistogramVector("genfiles/Fields/HOGFieldOneNear.dat");
		ColorFieldFar  = openFiletoGetHistogramVector("genfiles/Fields/ColorFieldOneFar.dat");
		ColorFieldMed  = openFiletoGetHistogramVector("genfiles/Fields/ColorFieldOneMed.dat");
		ColorFieldNear = openFiletoGetHistogramVector("genfiles/Fields/ColorFieldOneNear.dat");
		} ///Endif Variables.count ("F1")

		if (variables.count("F2")) ///Field Two
		{
		HOGFieldFar    = openFiletoGetHistogramVector("genfiles/Fields/HOGFieldTwoFar.dat");
		HOGFieldMed    = openFiletoGetHistogramVector("genfiles/Fields/HOGFieldTwoMed.dat");
		HOGFieldNear   = openFiletoGetHistogramVector("genfiles/Fields/HOGFieldTwoNear.dat");
		ColorFieldFar  = openFiletoGetHistogramVector("genfiles/Fields/ColorFieldTwoFar.dat");
		ColorFieldMed  = openFiletoGetHistogramVector("genfiles/Fields/ColorFieldTwoMed.dat");
		ColorFieldNear = openFiletoGetHistogramVector("genfiles/Fields/ColorFieldTwoNear.dat");
		} ///Endif Variables.count ("F2")

		if (variables.count("F3")) ///Field Three
		{
		HOGFieldFar    = openFiletoGetHistogramVector("genfiles/Fields/HOGFieldThreeFar.dat");
		HOGFieldMed    = openFiletoGetHistogramVector("genfiles/Fields/HOGFieldThreeMed.dat");
		HOGFieldNear   = openFiletoGetHistogramVector("genfiles/Fields/HOGFieldThreeNear.dat");
		ColorFieldFar  = openFiletoGetHistogramVector("genfiles/Fields/ColorFieldThreeFar.dat");
		ColorFieldMed  = openFiletoGetHistogramVector("genfiles/Fields/ColorFieldThreeMed.dat");
		ColorFieldNear = openFiletoGetHistogramVector("genfiles/Fields/ColorFieldThreeNear.dat");
		} ///Endif Variables.count ("F3")

		if (variables.count("F4")) ///Field Four
		{
		HOGFieldFar    = openFiletoGetHistogramVector("genfiles/Fields/HOGFieldFourFar.dat");
		HOGFieldMed    = openFiletoGetHistogramVector("genfiles/Fields/HOGFieldFourMed.dat");
		HOGFieldNear   = openFiletoGetHistogramVector("genfiles/Fields/HOGFieldFourNear.dat");
		ColorFieldFar  = openFiletoGetHistogramVector("genfiles/Fields/ColorFieldFourFar.dat");
		ColorFieldMed  = openFiletoGetHistogramVector("genfiles/Fields/ColorFieldFourMed.dat");
		ColorFieldNear = openFiletoGetHistogramVector("genfiles/Fields/ColorFieldFourNear.dat");
		} ///Endif Variables.count ("F4")

		/// Bhattacharyya Distance For HOG-- Second parameter (3)
		DistHOGFAR    = 1 - compareHist( HOGFieldFar    , FeatureVectorTest , 3 );
		DistHOGMED    = 1 - compareHist( HOGFieldMed    , FeatureVectorTest , 3 );
		DistHOGNEAR   = 1 - compareHist( HOGFieldNear   , FeatureVectorTest , 3 );


		/// Bhattacharyya Distance For HSV Color-- Second parameter (3)
		DistColorFAR  = 1 - compareHist( ColorFieldFar  ,     HistTest      , 3 );
		DistColorMED  = 1 - compareHist( ColorFieldMed  ,     HistTest      , 3 );
		DistColorNEAR = 1 - compareHist( ColorFieldNear ,     HistTest      , 3 );
	...
	if ((ProbFAR > ProbMED) && (ProbFAR > ProbNEAR))   
		{Prob = ProbFAR; flagfar = true;}

	if ((ProbMED > ProbFAR) && (ProbMED > ProbNEAR))   
		{Prob = ProbMED; flagmed = true;}

	if ((ProbNEAR > ProbFAR) && (ProbNEAR > ProbMED))  
		{Prob = ProbNEAR; flagnear = true;}
...
inicio = 0;
   ...
   //******************************************************************************************
	...
	string FileHOG  = "genfiles/Fields/HOGField"+ N + D +".dat";
	string FileColor  = "genfiles/Fields/ColorField"+ N + D +".dat";
